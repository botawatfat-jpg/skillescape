  ...
  useEffect(() => {
    ...
    if (pageId === 57) {
      ...
      trackEvent("quiz_result_view", {
        ...
        stopping: quizData.stopping,
        agreement: quizData.agreement,
        freedom: quizData.freedom,
        readiness: quizData.readiness,
        coding: quizData.coding,
        freelancing: quizData.freelancing,
        independence: quizData.independence,
        moneyStress: quizData.moneyStress,
        extraIncome: quizData.extraIncome,
        smarterWay: quizData.smarterWay,
        aiMeaning: quizData.aiMeaning,
        incomeGoal: quizData.incomeGoal,
        financesNormal: quizData.financesNormal,
        workStyle: quizData.workStyle,
        idealHours: quizData.idealHours,
        fallingBehind: quizData.fallingBehind,
        socialMediaTime: quizData.socialMediaTime,
        excitingThing: quizData.excitingThing,
        aiTools: quizData.aiTools,
        confidenceFactor: quizData.confidenceFactor,
        guidedPlan: quizData.guidedPlan,
        knowsClientMethods: quizData.knowsClientMethods,
        earningTimeline: quizData.earningTimeline,
        knowsAiAutomation: quizData.knowsAiAutomation,
        priceThreshold: quizData.priceThreshold,
        moneyReason: quizData.moneyReason,
        goalAmount: quizData.goalAmount,
        timeCommitment: quizData.timeCommitment,
        readyToTakeControl: quizData.readyToTakeControl,
        commit30Min: quizData.commit30Min,
        wantsHelpBuildingProject: quizData.wantsHelpBuildingProject,
        email: quizData.email,
        agreeToReceive: quizData.agreeToReceive,
        name: quizData.name,
